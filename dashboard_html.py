"""
dashboard_html.py — Gerador do HTML/design do dashboard
Muda quando ajustamos o visual. Importa as APIs do dashboard_api.
"""
import json, base64, os
from datetime import datetime
from dashboard_api import (
    carregar_logo_base64, META_VGV_PADRAO, META_ENTRADA_PADRAO
)
